...
def main(args):
  ...
  while True:
    ...
    # to red box
    if red_list[1] in target_frame or red_list[2] in target_frame or yellow_list[0] in target_frame:
        ur5.moveit_hard_play_planned_path_from_file(ur5._file_path, 'redbin_to_pkg.yaml', 5)
    # to yellow box
    elif yellow_list[1] in target_frame or yellow_list[2] in target_frame or green_list[0] in target_frame:
        ur5.moveit_hard_play_planned_path_from_file(ur5._file_path, 'yellowbin_to_pkg.yaml', 5)
    # to green box
    elif green_list[1] in target_frame or green_list[2] in target_frame :
    ...
    if red_list[0] in target_frame or red_list[1] in target_frame or red_list[2] in target_frame:
    ...
    elif yellow_list[0] in target_frame or yellow_list[1] in target_frame or yellow_list[2] in target_frame:
    ...
    elif green_list[0] in target_frame or green_list[1] in target_frame or green_list[2] in target_frame :
